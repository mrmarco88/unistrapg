...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "unistrapg@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "unistrapg API";

        private String description = "unistrapg API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "unistrapg";
